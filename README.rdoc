...
association with the name provided exists, MetaWhere::PredicateBuilder will build the
...
the <tt>:not_matches</tt> (NOT LIKE) and <tt>:not_in</tt> (NOT IN (val1, val2)) predications.
